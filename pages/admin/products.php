                                ...
                                <?php foreach($products as $product): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <select name="selected_size" id="size-select-<?php echo $product['product_id']; ?>" class="size-dropdown rounded-lg border-gray-300 border px-3 py-2 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200" onchange="updateStock(this, <?php echo $product['product_id']; ?>)">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex items-center justify-center gap-3">
                                                <button type="button" onclick="editProduct(<?php echo $product['product_id']; ?>)" class="text-blue-600 hover:text-blue-800 transition cursor-pointer">
                                                ...
                                                <button type="button" onclick="deleteProduct(<?php echo $product['product_id']; ?>)" class="text-red-600 hover:text-red-800 transition cursor-pointer">
