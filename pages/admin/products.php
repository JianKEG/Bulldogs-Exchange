                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex items-center justify-center gap-3">
                                                <button type="button" onclick="editProduct(<?php echo $row['product_id']; ?>)" class="text-blue-600 hover:text-blue-800 transition cursor-pointer">
                                                ...
                                                <button type="button" onclick="deleteProduct(<?php echo $row['product_id']; ?>)" class="text-red-600 hover:text-red-800 transition cursor-pointer">
