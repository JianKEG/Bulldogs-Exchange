                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <?php if ($status_value === 'pending') { ?>
                                        <div class="flex gap-2">
                                            ...
                                            <a href="../../actions/admin/reservation/cancelReservation.php?id=<?php echo $row['reservation_id']; ?>&pssid=<?php echo $row['pssid']; ?>&quantity=<?php echo $row['quantity']; ?>" class="inline-flex items-center rounded-lg bg-yellow-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-yellow-700 transition" onclick="return confirm('Cancel this reservation?')">
                                                Cancel
                                            </a>
                                        </div>
